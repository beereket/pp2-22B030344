            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if button.eraser_rect.collidepoint(pygame.mouse.get_pos()):
                    ...
                    if current_shape == 'pen':
                        active_obj = Pen( 5, color, SCREEN, colorstart_pos=event.pos)
                        ...
                        active_obj = Square(color, SCREEN, start_pos=event.pos)
                    elif current_shape == 'rhomb':
                        active_obj = Rhombus(color, SCREEN, start_pos=event.pos)
                    elif current_shape == 'eraser':
                        active_obj = Pen(30, 'white', SCREEN, colorstart_pos=event.pos)
